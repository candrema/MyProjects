...
<body>
                  ...
                  <li class="dropdown nav-item">
                    <a href="#pablo" class="profile-photo dropdown-toggle nav-link" data-toggle="dropdown">
                      <div class="profile-photo-small">
                        <img src="./assets/img/faces/photo.jpg" alt="Circle Image" class="rounded img-fluid">
                      </div>
                    </a>
    ...
    <div class="section" id="carousel">
      <div class="container">
       ...
       <div class="col-3" > 
       <div class="bodytabNews">
			<table class="leaderTable">
				<tbody>

					<tr>
						<td>
							<!--  --><img src="./assets/img/rocketleague.png" alt="Rounded Image" class="gamelogo">
						</td>
						<td>1 - Jogo 1</td>
						<td>10</td>
					</tr>
					...
					<tr>
						<td><!--  --><img src="./assets/img/rocketleague.png" alt="Rounded Image" class="gamelogo"></td>
						<td>3 - Jogo 3</td>
						<td>8</td>
					</tr>
					<tr>
       ...
       <br>
   	    ...
   	    <div class ="row" >
 	   		<div class="col-sm-3" >
				<img src="./assets/img/example1.jpg" alt="Rounded Image" class="img-fluid mostVotedImage">
				<div class ="newsImage"> Vote Here Now!! </div>
			</div>
			<div class="col-sm-3 ml-auto">
				<img src="./assets/img/example1.jpg" alt="Rounded Image" class="img-fluid mostVotedImage">
				<div class ="newsImage"> TEste 123dasdasdadsad</div>
			</div>
			<div class="col-sm-3 ml-auto">
				<img src="./assets/img/example1.jpg" alt="Rounded Image" class="img-fluid mostVotedImage">
				<div class ="newsImage"> TEste 123dasdasdadsad</div>
    ...
    <div class = "col-sm-6">
    	<a> Features </a>
    	<br>
    	<div class ="row bodyImage">
    		<div class = "col-sm-5 bodycol">
    			<img src="./assets/img/example1.jpg" alt="Rounded Image" class="rounded img-fluid">
    		</div>
    		<div class ="col-sm-3">
    			coisas novas blablablalbalblalbalblalbalbla lbalblalbalblalbalblalbalblalbalblalbalbal
    		</div>
    	 </div>
	...
	<div class = "col-sm-6">
    	...
    	<div class ="row bodyImage">
    		...
    		<div class ="col-sm-3">
    			coisas novas blablablalbalblalbalblalbalblal balblalbalblalbalblalbalblalbalblalbalbal
    		</div>
    	 </div>
